...
def get_info_ogrn(browser, wait, ogrn_or_inn):
    ...
    try:
        browser.get(f'https://pb.nalog.ru/search.html#t=1718002842355&mode=search-all&queryAll={ogrn_or_inn}&page=1&pageSize=10')
        wait.until(
        ...
        labels_and_xpaths_ip = {
            **common_xpaths,
            "name": "//*[contains(text(), 'ФИО:')]/following-sibling::*[1]",
            "citizenship": "//*[contains(text(), 'Сведения о гражданстве:')]/following-sibling::*[1]",
            "ogrnip": "//*[contains(text(), 'ОГРНИП:')]/following-sibling::*[1]",
            "registration_date": "//*[contains(text(), 'Дата постановки на учёт:')]/following-sibling::*[1]"
        }
...
print(scrape_ogrn_info('233910268521'))